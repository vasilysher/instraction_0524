...
Небольшой нюанс, при работе с **__github.com__**, если на собственном устройстве установлено несколько браузеров, то вся загрузка/выгрузка файлов производится только через браузер который является основным.
